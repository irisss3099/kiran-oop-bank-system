...
class Customer {
    ...
    accNumber;
    balance;
    constructor(name, age, gender, mobNumber, accNumber, balance) {
        this.name = name;
        this.age = age;
        this.gender = gender;
...
class myBank {
    ...
    async createAcc() {
        const { name, age, gender, mobNumber, accNumber, balance } = await inquirer.prompt([
            {
                name: "name",
                type: "input",
        ...
        const cust = new Customer(name, parseInt(age), gender, parseInt(mobNumber), parseInt(accNumber), parseFloat(balance));
